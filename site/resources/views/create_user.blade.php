                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form  action="{{route('user.store')}}" method="POST">
                                     ...
                                     <div class="form-floating mb-3">
                                        <input class="form-control" id="inputEmail" type="text" placeholder="name@example.com" name="name" />
                                   ...
                                   <div class="form-floating mb-3">
                                     <select class="form-control " name="type_user">
                                       ...
                                       <option>Type Utilisateurs</option>
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" name="confim_password" id="inputPassword" type="password" placeholder="Password" />
